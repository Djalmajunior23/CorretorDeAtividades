...
export default function PlanejamentoView() {
  ...
  const [aiPrompt, setAiPrompt] = useState(
    "Monte um planejamento de 80 horas para Lógica de Programação com 20 encontros.",
  );
  ...
  const [schedules, setSchedules] = useState<any[]>([
    {
      id: 1,
      week: 1,
      title: "Introdução à Lógica & Variáveis",
      hrs: 4,
      competency: "Compreender variáveis e tipos de dados primitivos",
      date: "2026-08-03",
      status: "executed",
      canceled: false,
    },
    {
      id: 2,
      week: 1,
      title: "Estruturas Condicionais Simples/Compostas",
      hrs: 4,
      competency: "Aplicar blocos de decisão para fluxo lógico",
      date: "2026-08-10",
      status: "executed",
      canceled: false,
    },
    {
      id: 3,
      week: 2,
      title: "Operadores Lógicos e Aritméticos",
      hrs: 4,
      competency: "Aplicar lógica booleana complexa em expressões",
      date: "2026-08-17",
      status: "executed",
      canceled: false,
    },
    {
      id: 4,
      week: 2,
      title: "Estruturas de Repetição (Para, Enquanto)",
      hrs: 4,
      competency: "Estruturar loops de varredura e iterações finitas",
      date: "2026-08-24",
      status: "scheduled",
      canceled: false,
    },
    {
      id: 5,
      week: 3,
      title: "Vetores e Arrays Unidimensionais",
      hrs: 4,
      competency: "Manipular arranjos lineares e indexação linear",
      date: "2026-08-31",
      status: "scheduled",
      canceled: false,
    },
    {
      id: 6,
      week: 3,
      title: "Feriado Estadual (Ajustado)",
      hrs: 0,
      competency: "Nenhum - Feriado",
      date: "2026-09-07",
      status: "scheduled",
      canceled: true,
    },
    {
      id: 7,
      week: 4,
      title: "Matrizes e Arrays Multidimensionais",
      hrs: 4,
      competency: "Manipular arranjos bidimensionais e coordenadas XY",
      date: "2026-09-14",
      status: "scheduled",
      canceled: false,
    },
    {
      id: 8,
      week: 4,
      title: "Subalgoritmos (Funções e Procedimentos)",
      hrs: 4,
      competency: "Abstrair sub-rotinas escaláveis e escopo de variáveis",
      date: "2026-09-21",
      status: "scheduled",
      canceled: false,
    },
    {
      ...
      hrs: 4,
      competency: "Diferenciar ponteiros lógicos de envio na pilha",
      date: "2026-09-28",
      status: "scheduled",
      canceled: false,
    },
    {
      id: 10,
      week: 5,
      title: "Avaliação Intermediária de Competências",
      hrs: 4,
      competency: "Avaliar o raciocínio sintático e estrutural por rubrica",
      date: "2026-10-05",
      status: "scheduled",
      canceled: false,
    },
  ...
  const [competencies, setCompetencies] = useState([
    {
      code: "COMP-01",
      name: "Compreensão Lógica e Tipos de Dados",
      hrs: 12,
      status: "aligned",
      coverage: 100,
      classCount: 3,
      assessments: ["Lista 01: Variáveis", "Simulado Geral Lógica"],
    },
    {
      code: "COMP-02",
      name: "Estruturas de Fluxo e Iterações",
      hrs: 16,
      status: "aligned",
      coverage: 75,
      classCount: 4,
      assessments: ["Lista 02: Loops e Seleções"],
    },
    {
      code: "COMP-03",
      name: "Manipulação de Estruturas Bidimensionais",
      hrs: 20,
      status: "partial",
      coverage: 50,
      classCount: 2,
    ...
    {
      code: "COMP-04",
      name: "Funções e Procedimentos Modulares",
      hrs: 16,
      status: "risk",
      coverage: 0,
      classCount: 0,
    ...
    {
      code: "COMP-05",
      name: "Algoritmos de Ordenação e Pilhas",
      hrs: 16,
      status: "risk",
      coverage: 0,
      classCount: 0,
  ...
  const classAlerts = [
    {
      type: "danger",
      text: "Competência COMP-04 (Módulos) está agendada para semana 4 mas não possui avaliação vinculada.",
      fix: "Sugira criar uma avaliação na Central de Avaliações",
    },
    {
      type: "warning",
      text: "Registrado 1 feriado oficial em 2026-09-07 que cancelou uma aula teórica. Redistribuição recomendada.",
      fix: "Clique em Replanejar Cronograma para redistribuir horas",
    },
  ];
    ...
    try {
      ...
      if (Array.isArray(data) && data.length > 0) {
        ...
        setSuggestedResult([
          {
            week: 1,
            title: "Lógica de Programação, Variáveis Primitivas e Comportas",
            hrs: 4,
            competency: "Iniciação lógica estruturada",
          },
          {
            week: 2,
            title: "Operadores Aritméticos, Relacionais e Decisórios",
            hrs: 4,
            competency: "Escrita de testes lógicos condicionais",
          },
          {
            week: 3,
            title: "Estruturas de Repetição Encadeadas (For/While)",
            hrs: 4,
            competency: "Otimização de laços iterativos",
          },
        ]);
      }
  ...
  const handleSuggestedFieldChange = (
    index: number,
    field: string,
    value: any,
  ) => {
  ...
  const handleApproveSuggested = async () => {
    ...
    const hasEmptyFields = aiSuggestedResult.some(
      (res) =>
        !res.title?.toString().trim() ||
        !res.competency?.toString().trim() ||
        !res.week ||
        !res.hrs,
    );
    ...
    if (hasEmptyFields) {
      alert(
        "Existem campos obrigatórios vazios ou inválidos no cronograma. Por favor, preencha todos os campos antes de salvar.",
      );
      return;
    }
    ...
    const updated = schedules.map((sched) => {
      ...
      if (sched.id === 7 || sched.id === 8) {
        ...
        return {
          ...sched,
          hrs: sched.hrs + 2,
          title: sched.title + " (Carga Ampliada)",
        };
      }
      return sched;
    });
      ...
      prev.map((s) =>
        s.date === newHoliday
          ? {
              ...
              canceled: true,
              hrs: 0,
              title: "Feriado Lançado/Aula Suspensa",
            }
          : s,
      ),
    );
  ...
  const handleExportPDF = () => {
    ...
    const tableData = schedules.map((s) => [
      ...
      s.title,
      `${s.hrs} hrs`,
      s.canceled ? "Cancelada/Feriado" : "Regular",
      s.competency,
    ]);
  ...
  const hrsExecuted = schedules
    .filter((s) => s.status === "executed")
    .reduce((acc, current) => acc + current.hrs, 0);
  const hrsScheduled = schedules
    .filter((s) => s.status === "scheduled" && !s.canceled)
    .reduce((acc, current) => acc + current.hrs, 0);
  const percentCompleted = Math.round(
    (hrsExecuted / (hrsExecuted + hrsScheduled || 1)) * 100,
  );
      ...
      <div className="flex flex-col md:flex-row justify-between items-start gap-4">
        <div>
          <span className="text-xs font-mono font-bold tracking-widest text-[#10b981] uppercase">
            Fase 12: Ecossistema Pedagógico de Planejamento
          </span>
          <h1 className="text-3xl font-extrabold text-white tracking-tight font-display mt-0.5">
            Planejamento Semestral de Ensino
          </h1>
          <p className="text-sm text-slate-400 mt-1">
            Gere cronogramas automatizados com IA, monitore a cobertura do
            currículo do SENAI por competências e faça replanejamento dinâmico
            sem fricção.
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-8 grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="p-5 rounded-2xl bg-[#0f172a] border border-slate-800 flex flex-col justify-between">
            ...
            <div className="mt-4">
              <span className="text-3xl font-extrabold text-white">
                {hrsExecuted + hrsScheduled}h
              </span>
              <span className="text-xs text-slate-500 font-mono ml-1.5">
                de {totalHours}h previstas
              </span>
              <div className="w-full bg-slate-800 h-1.5 rounded-full mt-3 overflow-hidden">
                <div
                  className="bg-emerald-400 h-full rounded-full"
                  style={{
                    width: `${Math.min(100, ((hrsExecuted + hrsScheduled) / totalHours) * 100)}%`,
                  }}
                />
              </div>
            </div>
          ...
          <div className="p-5 rounded-2xl bg-[#0f172a] border border-slate-800 flex flex-col justify-between">
            ...
            <div className="mt-4">
              <span className="text-3xl font-extrabold text-white">
                {competencies.filter((c) => c.coverage >= 50).length} /{" "}
                {competencies.length}
              </span>
              <span className="text-xs text-slate-500 font-mono ml-1.5">
                acima de 50% de foco
              ...
              <div className="w-full bg-slate-800 h-1.5 rounded-full mt-3 overflow-hidden">
                <div
                  ...
                  style={{
                    width: `${(competencies.filter((c) => c.coverage >= 50).length / competencies.length) * 100}%`,
                  }}
                />
              </div>
            </div>
        ...
        <div className="lg:col-span-4 p-5 rounded-2xl bg-[#0f172a] border border-slate-800">
          ...
          <div className="flex flex-col gap-2">
            {classAlerts.map((alert, i) => (
              <div
                key={i}
                className="p-2.5 rounded-xl bg-amber-500/5 border border-amber-500/10 text-slate-300 text-[11px] leading-relaxed"
              >
                <span className="font-semibold block mb-0.5 text-amber-400">
                  ● {alert.text}
                </span>
                <span className="text-slate-500 font-medium">
                  Recomendado: {alert.fix}
                </span>
              </div>
            ))}
          </div>
          ...
          <div className="p-6 rounded-2xl bg-[#0f172a] border border-slate-800 flex flex-col gap-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="flex flex-col gap-2">
                ...
                <form onSubmit={handleAddHoliday} className="flex gap-2">
                  ...
                  <button
                    type="submit"
                    className="px-3 bg-emerald-500 hover:bg-emerald-600 font-bold font-mono text-xs text-[#030712] rounded-xl cursor-pointer"
                  >
                    +
                  </button>
                </form>
            ...
            {holidays.length > 0 && (
              <div className="flex flex-wrap gap-2 pt-2 border-t border-slate-900">
                <span className="text-[10px] font-mono font-bold text-slate-500 uppercase mt-1 shrink-0">
                  Feriados Ativos:
                </span>
                {holidays.map((hol, idx) => (
                  <span
                    key={idx}
                    className="text-[10px] bg-slate-900 border border-slate-800 text-slate-400 font-mono px-2.5 py-1 rounded-lg flex items-center gap-1"
                  >
                    {hol}
                    <button
                      type="button"
                      onClick={() =>
                        setHolidays(holidays.filter((h) => h !== hol))
                      }
            ...
            <div className="flex items-center gap-2.5">
              ...
              <div>
                ...
                <p className="text-xs text-slate-400">
                  Comando inteligente para estruturar toda a ementa de aulas
                ...
                >
                  <div className="flex items-center justify-between">
                    <span className="text-xs font-bold text-emerald-400 font-mono">
                      Sugestão de Cronograma Encontrada:
                    </span>
                  </div>
          ...
          <div className="p-6 rounded-2xl bg-[#0f172a] border border-slate-800 flex flex-col gap-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-slate-400">
                  Visão cronológica linear e estrutural do semestre letivo.
                </p>
              </div>
                ...
                >
                  <div className="flex items-center justify-between">
                    <span className="font-bold text-amber-400">
                      Sugestão de Represamento e Redistribuição
                    </span>
                    <button
                  ...
                  <p className="text-[11px] text-slate-400">
                    A aula cancelada em <strong>2026-09-07</strong> causou
                    déficit de 4h. Sugerimos compensar ampliando a carga horária
                    das semanas 4 e 5 consecutivas (+2 horas cada encontro).
                  </p>
                </motion.div>
              )}
            </AnimatePresence>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex flex-col gap-0.5">
                      <div className="flex items-center gap-2">
                        <span
                          className={`text-xs font-bold ${sched.canceled ? "line-through text-slate-400" : "text-white"}`}
                        >
                          {sched.title}
                        </span>
                        {sched.canceled && (
                          <span className="text-[8px] bg-rose-500/20 text-rose-300 font-mono font-bold px-1.5 py-0.2 rounded uppercase">
                            Cancelada
                          </span>
                        )}
                        {sched.status === "executed" && (
                          <span className="text-[8px] bg-emerald-500/20 text-emerald-300 font-mono font-bold px-1.5 py-0.2 rounded uppercase">
                            Lançado no Diário
                          </span>
                        )}
                      </div>
                      <span className="text-[10px] text-slate-400 font-mono italic">
                        COMPETÊNCIA: {sched.competency}
                      </span>
                    </div>
                  </div>
        ...
        <div className="lg:col-span-4 flex flex-col gap-6">
          <div className="p-6 rounded-2xl bg-[#0f172a] border border-slate-800">
            ...
            <p className="text-xs text-slate-400 mb-4">
              Associação das pautas didáticas às competências requeridas pelo
              SENAI.
            </p>
                ...
                >
                  <div className="flex justify-between items-start gap-2">
                    <div className="flex flex-col">
                      <span className="text-[10px] font-mono font-bold text-emerald-400 leading-normal">
                        {comp.code}
                      </span>
                      <span className="text-xs font-bold text-slate-200 mt-0.5 leading-normal">
                        {comp.name}
                      </span>
                    </div>
                  ...
                  <div className="flex flex-col gap-1 mt-1">
                    ...
                    <div className="w-full bg-slate-950 h-1.5 rounded-full overflow-hidden">
                      <div
                        className={`h-full rounded-full ${comp.coverage === 100 ? "bg-emerald-400" : "bg-amber-400"}`}
                    ...
                    <div className="flex flex-col gap-1 mt-1">
                      ...
                      <div className="flex flex-wrap gap-1">
                        {comp.assessments.map((as, i) => (
                          <span
                            key={i}
                            className="text-[8px] bg-slate-950 text-slate-400 px-1.5 py-0.5 rounded border border-slate-900 font-semibold"
                          >
                            {as}
                          </span>
                        ))}
