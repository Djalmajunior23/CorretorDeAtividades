...
export default function DashboardView({ onNavigate }: DashboardViewProps) {
  ...
  const alerts = [
    {
      id: 1,
      type: "danger",
      title: "Carga Horária Crítica",
      desc: "A Turma Desarrollo Web 1A está com desvio de -8h no cronograma planejado.",
      time: "há 10 min",
    },
    {
      id: 2,
      type: "warning",
      title: "Competência Descoberta",
      desc: "Competência 'Estruturas de Dados Dinâmicas' prevista para esta semana não foi associada a nenhuma avaliação.",
      time: "há 1 hora",
    },
    {
      id: 3,
      ...
      desc: "3 alunos ingressaram automaticamente no módulo de recuperação em Lógica de Programação.",
      time: "há 2 horas",
    },
    {
      id: 4,
      type: "success",
      title: "Parecer Técnico Concluído",
      desc: "O feedback consolidado da Unidade Curricular de Banco de Dados foi gerado via IA.",
      time: "há 4 horas",
    },
  ];
  ...
  const classList = [
    {
      name: "Turma de Desenvolvimento Web 1A",
      uc: "Lógica e Algoritmos",
      progress: 68,
      activeStudents: 24,
      nextAssessment: "Simulado SAEP Técnica",
    },
    {
      name: "Análise de Sistemas 2B",
      uc: "Bancos de Dados Relacionais",
      progress: 42,
      activeStudents: 18,
      nextAssessment: "Projeto Prático Integrador",
    },
    {
      name: "Sistemas Embarcados 1C",
      uc: "Arquitetura e I/O",
      progress: 85,
      activeStudents: 15,
      nextAssessment: "Prova de Recuperação Alternativa",
    },
    {
      name: "Programação Mobile 4A",
      uc: "Desenvolvimento Android Native",
      progress: 15,
      activeStudents: 20,
      nextAssessment: "Teste de Competência Inicial",
    },
  ];
  ...
  const pendingGrades = [
    {
      ...
      activity: "Algoritmos de Ordenação",
      lang: "python",
      date: "Hoje, 14:32",
    },
    {
      student: "Beatriz Oliveira Costa",
      activity: "Modelagem Entidade Relacionamento",
      lang: "sql",
      date: "Hoje, 12:11",
    },
    {
      student: "Daniel Santos Ramos",
      activity: "Manipulação de Pontes e Vetores",
      lang: "c",
      date: "Ontem, 18:40",
    },
  ];
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-slate-400 mt-1">
            Acompanhe cronogramas, feedbacks pendentes, matrizes operacionais de
            competência e alertas em tempo real.
          </p>
        </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        >
          <div className="flex justify-between items-start">
            ...
            <span className="text-[10px] font-mono font-bold text-amber-500 bg-amber-500/10 px-2.5 py-0.5 rounded-full uppercase tracking-widest">
              Pendente
            </span>
          </div>
          <div className="mt-4">
            <span className="text-3xl font-extrabold text-white leading-none tracking-tight">
              {stats.toCorrectCount}
            </span>
            <h4 className="text-xs font-bold text-slate-400 mt-1 uppercase tracking-wide font-mono">
              Submissões a Corrigir
            </h4>
        ...
        >
          <div className="flex justify-between items-start">
            ...
            <span className="text-[10px] font-mono font-bold text-rose-400 bg-rose-500/10 px-2.5 py-0.5 rounded-full uppercase tracking-widest">
              Alerta
            </span>
          </div>
          <div className="mt-4">
            <span className="text-3xl font-extrabold text-white leading-none tracking-tight">
              {stats.criticalCompetencies}
            </span>
            <h4 className="text-xs font-bold text-slate-400 mt-1 uppercase tracking-wide font-mono">
              Competências Críticas
            </h4>
            <p className="text-[10px] text-slate-500 mt-1.5 leading-relaxed">
              Assuntos do programa pedagógico apresentando defasagem
              estatística.
            </p>
          </div>
          <div className="flex items-center gap-1.5 text-xs text-emerald-400 font-bold font-mono mt-4 opacity-0 group-hover:opacity-100 transition-all">
        ...
        >
          <div className="flex justify-between items-start">
            ...
            <span className="text-[10px] font-mono font-bold text-purple-400 bg-purple-500/10 px-2.5 py-0.5 rounded-full uppercase tracking-widest">
              Ativo
            </span>
          </div>
          <div className="mt-4">
            <span className="text-3xl font-extrabold text-white leading-none tracking-tight">
              {stats.pendingRecoveries}
            </span>
            <h4 className="text-xs font-bold text-slate-400 mt-1 uppercase tracking-wide font-mono">
              Planos de Recuperação
            </h4>
            <p className="text-[10px] text-slate-500 mt-1.5 leading-relaxed">
              Estudantes recebendo instrução adaptativa e replanejamento
              complementar.
            </p>
          </div>
          <div className="flex items-center gap-1.5 text-xs text-emerald-400 font-bold font-mono mt-4 opacity-0 group-hover:opacity-100 transition-all">
        ...
        >
          <div className="flex justify-between items-start">
            ...
            <span className="text-[10px] font-mono font-bold text-emerald-400 bg-emerald-500/10 px-2.5 py-0.5 rounded-full uppercase tracking-widest">
              Ativas
            </span>
          </div>
          <div className="mt-4">
            ...
            <p className="text-[10px] text-slate-500 mt-1.5 leading-relaxed">
              Consolidação de frequência, diários letivos e aproveitamento
              semanal.
            </p>
          </div>
          <div className="flex items-center gap-1.5 text-xs text-emerald-400 font-bold font-mono mt-4 opacity-0 group-hover:opacity-100 transition-all">
        ...
        <div className="lg:col-span-8 flex flex-col gap-6">
            ...
            <div className="flex items-center justify-between mb-6">
              <div>
                <h3 className="text-lg font-bold text-white">
                  Status das Unidades Curriculares
                </h3>
                <p className="text-xs text-slate-400">
                  Turmas, cumprimento de carga horária e planos de aula
                  estruturados.
                </p>
              </div>
              <button
          ...
          <div className="p-6 rounded-2xl bg-[#0f172a] border border-slate-800">
            <div className="flex items-center justify-between mb-4">
              <div>
                <h3 className="text-lg font-bold text-white">
                  Próximos Conteúdos Planejados (Semana)
                </h3>
                <p className="text-xs text-slate-400 font-mono">
                  Sincronizado diretamente com a Matriz Curricular Integrada.
                </p>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="p-4 rounded-xl bg-slate-950 border border-slate-850 flex flex-col justify-between">
                <div>
                  ...
                  <h4 className="text-xs font-bold text-slate-200 mt-2">
                    Recursividade Aplicada e Call Stack
                  </h4>
                  <p className="text-[10px] text-slate-500 mt-1 leading-relaxed">
                    Apresentar conceitos de recursão pura vs cauda. Utilizar
                    simulação interativa integrada.
                  </p>
                </div>
              ...
              <div className="p-4 rounded-xl bg-slate-950 border border-slate-850 flex flex-col justify-between">
                <div>
                  ...
                  <p className="text-[10px] text-slate-500 mt-1 leading-relaxed">
                    Formas normais complementares e integridade referencial
                    prática com simulador local SQL.
                  </p>
                </div>
                <div className="mt-4 border-t border-slate-900 pt-3 flex items-center justify-between text-[11px] text-slate-400">
        ...
        <div className="lg:col-span-4 flex flex-col gap-6">
          ...
          <div className="p-6 rounded-2xl bg-[#0f172a] border border-slate-800">
            ...
            <p className="text-xs text-slate-400 mb-4">
              Intercorrências detectadas pela IA no planejamento ou turmas.
            </p>
                ...
                >
                  ...
                  <div className="flex flex-col gap-0.5">
                    <div className="flex items-center justify-between gap-2">
                      ...
                      <span className="text-[9px] text-slate-500 font-mono text-right font-normal shrink-0">
                        {alert.time}
                      </span>
                    </div>
          ...
          <div className="p-6 rounded-2xl bg-[#0f172a] border border-slate-800">
            ...
            <p className="text-xs text-slate-400 mb-4">
              Envios recentes aguardando validação de critérios.
            </p>
